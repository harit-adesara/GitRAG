...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex items-center justify-center px-4 py-10 font-sans">
      {/* Ambient glow — matches Login exactly */}
          ...
          <div className="space-y-5">
            ...
            <form onSubmit={submitHandler} className="space-y-5" noValidate>
              ...
              <div className="text-center">
                ...
                >
                  Already registered or didn't receive the email? Click here
                </Link>
              </div>
